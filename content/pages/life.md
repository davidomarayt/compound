...
<section class="life-hero">
  <div class="life-hero-copy">
    <p class="eyebrow">COMPOUND LIFE</p>
    <h1>Make more of<br>everyday life.</h1>
    <p>Practical guides, useful tools and thoughtful ideas for how you live, work, connect and spend your time in Ireland.</p>
    <div class="life-principles" aria-label="Compound Life principles"><span>Useful, not noisy</span><span>Built for Ireland</span><span>Practical tools</span><span>Worth your time</span></div>
  </div>
  <div class="life-hero-note" aria-hidden="true">
    <span>HEALTH</span><span>WEALTH</span><strong>LIFE</strong>
  </div>
</section>

<section class="life-intro" aria-labelledby="life-start-heading">
  <div><p class="eyebrow">CHOOSE A LIFE AREA</p><h2 id="life-start-heading">Six places to start.</h2></div>
  <p><strong>Life is deliberately broad, but the navigation is not.</strong> Start with the part of everyday life that matters now, then move between practical tools and deeper reading.</p>
</section>
...
<section class="life-category" id="travel-experiences" data-sponsorship-category="travel-experiences">
  ...
  <div class="life-resource-grid">
    ...
    <div class="life-resource is-coming"><small>Building next</small><h3>Travel planning guides</h3><p>Practical Irish-focused destination and trip-planning content will grow here as the Life section expands.</p><strong>More coming to Compound Life</strong></div>
  </div>
</section>
...
<section class="life-category" id="home-everyday-life" data-sponsorship-category="home-everyday-life">
  ...
  <div class="life-resource-grid">
    ...
    <a class="life-resource" href="/whole-house-retrofit-planner/"><small>Planner</small><h3>Whole-House Retrofit Planner</h3><p>Compare retrofit costs, grants, savings and indicative payback.</p><strong>Plan a retrofit →</strong></a>
  </div>
  <div class="life-reading">
...
<section class="life-editorial">
  <div><p class="eyebrow">WHAT COMPOUND LIFE IS FOR</p><h2>A better life is not one metric.</h2></div>
  <div><p>Health and money are important enough to have their own hubs. Life is where everything else meets: work, family, home, experiences, leisure and the people around you.</p><p>The aim is the same across Compound — useful information, clear assumptions and fewer empty lifestyle claims.</p><a href="/editorial-policy/">Read the Compound editorial policy →</a></div>
</section>

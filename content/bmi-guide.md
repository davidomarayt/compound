<h2 id="bmi-categories">What do the BMI ranges mean?</h2>

BMI divides weight in kilograms by height in metres squared. For example, **75 kg at 1.75 m gives a BMI of 24.49**. The number is the same whether you enter metric or imperial measurements: we convert before calculating.

The reference categories below follow NICE adult guidance. This is UK clinical guidance used here to explain the numerical thresholds; it is not an Irish treatment entitlement rule. [NICE, recommendations 1.9.10–1.9.13 [2]](#source-nice)

| Standard adult BMI | Screening category |
| --- | --- |
| Below 18.5 | Underweight |
| 18.5 to below 25 | Healthy weight |
| 25 to below 30 | Overweight |
| 30 to below 35 | Obesity class 1 |
| 35 to below 40 | Obesity class 2 |
...
### 1. Build movement into the week

Ireland’s national physical activity guidance recommends **150–300 minutes of moderate activity a week**, or **75–150 minutes of vigorous activity**, or a combination. Adults should also do muscle-strengthening activity on at least **2 days a week**. Reduce time spent sitting; some movement is better than none. [Every Move Counts, HSE [3]](#source-activity)

A practical example is a 30-minute brisk walk on five days, with two separate strength sessions. This is an illustration of how to organise the week, not a requirement to begin at that level. If you are starting from very little activity, build gradually. The HSE has advice on increasing activity and adapting it to your stage of life. [HSE activity guidance [4]](#source-hse-activity)

### 2. Use Irish healthy-eating guidance

Healthy Ireland recommends **5–7 servings of vegetables, salad and fruit each day**, more wholegrain foods and water in place of sugary drinks. Fresh, frozen and tinned foods can all help make meals practical and affordable. Healthy eating matters at any weight. [Healthy Ireland: Eat Well [5]](#source-food)
...
<details><summary>How do you calculate BMI from stones and feet?</summary><p>One stone is 14 pounds. We convert pounds to kilograms using 0.45359237 kg per pound, and inches to centimetres using 2.54 cm per inch. BMI = kg ÷ (metres × metres). Enter 0 in the pounds or inches box if it is not needed. Switching units converts complete, valid measurements.</p></details>

<details><summary>Why can a rounded result seem to sit in the wrong category?</summary><p>The large number is rounded to one decimal place; the category uses the unrounded calculation. A BMI of 24.96 displays as 25.0 but is still below 25. We show extra decimal places below the result so you can see why. Numerical precision does not remove uncertainty in your height and weight measurements.</p></details>

<details><summary>Is the BMI formula different for men and women?</summary><p>The adult calculation and the reference thresholds used here do not change by sex. Individual clinical interpretation may still differ. This tool does not apply adult BMI categories to children. [<a href="#source-nice">2</a>]</p></details>

<details><summary>Why is there no “ideal weight” or calorie target?</summary><p>A population screening category is not a personalised prescription. This calculator does not know your medical history, nutritional needs or goals. Use it to understand a measurement and prepare questions, rather than to choose a diet from a number.</p></details>

<details><summary>Are my measurements saved?</summary><p>The calculator performs its arithmetic in your browser. It does not put measurements in the URL, save them to local storage, or send them to Compound. Clear all removes the entered values. The site’s separate analytics choices are explained in our <a href="/privacy/">privacy policy</a>.</p></details>

<details><summary>What are the tool’s input limits?</summary><p>Height must be 100–250 cm and weight 20–500 kg, or their imperial equivalents. Waist input must be 30–300 cm or equivalent. These are software input checks, not definitions of health. If your measurements fall outside them, ask a healthcare professional for an appropriate assessment.</p></details>
...
<li id="source-nice"><a href="https://www.nice.org.uk/guidance/ng246/chapter/Identifying-and-assessing-overweight-obesity-and-central-adiposity">NICE NG246 — Identifying and assessing overweight, obesity and central adiposity</a>. Adult thresholds, ethnicity and older adults; recommendations 1.9.7–1.9.14. UK guidance.</li>
<li id="source-activity"><a href="https://about.hse.ie/news/every-move-counts-new-guidelines-aim-to-encourage-people-of-ireland-to-sit-less-and-get-more-active/">HSE — Every Move Counts</a>. National Physical Activity and Sedentary Behaviour Guidelines for Ireland, 2024.</li>
